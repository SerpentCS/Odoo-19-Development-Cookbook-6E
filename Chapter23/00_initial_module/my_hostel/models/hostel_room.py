...
class HostelRoom(models.Model):
    ...
    # optional attribute: currency_field='currency_id' incase currency field
    ...
    student_per_room = fields.Integer(
        "Student Per Room", help="Students allocated per room")
    ...
    room_category_id = fields.Many2one(
        'hostel.room.category', string='Room Category')

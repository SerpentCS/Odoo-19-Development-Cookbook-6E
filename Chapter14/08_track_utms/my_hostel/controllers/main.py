...
class InquiryForm(http.Controller):
    ...
    @http.route('/hostel/submit_issues', type='http', auth="user", website=True, methods=['GET', 'POST'])
    def hostel_issues(self, **post):

        return request.render('my_hostel.hostel_issue_form', {

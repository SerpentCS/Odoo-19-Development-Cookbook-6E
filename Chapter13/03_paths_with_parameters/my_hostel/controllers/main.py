...
class Main(http.Controller):
    ...
    @http.route(['/my_hostel/student_details/','/my_hostel/student_details/<int:student_id>'], type='http', auth='none')
    def student_details(self, student_id=False):
    ...
    def student_details_in_path(self, book):
        return self.student_details(book.id)
